...
(21, 'Pilisborosjenõ', '2005-03-21'),
(22, 'XXII. kerület', '2005-02-24'),
(23, 'Vértesszõlõs', '2005-01-10'),
...
(59, 'Pilisborosjenõ', '2004-09-02'),
(60, 'Gyulafirátót', '2004-08-31'),
(61, 'Mezõkövesd', '2004-12-30'),
...
(2, 'airedale terrier', 'kan', 1, 'Tódor'),
(3, 'airedale terrier', '', 6, 'Pamacs'),
(4, 'airedale terrier', 'szuka', 1, 'Moki'),
(5, 'akita', '', 0, 'Tapi'),
(6, 'akita', 'kan', 0, 'Tüske'),
(7, 'akita', 'kan', 8, 'Brúnó'),
(8, 'akita keverék', 'szuka', 0, 'Dorka'),
(9, 'angol buldog', 'szuka', 6, 'Gina'),
(10, 'angol buldog', 'kan', 2, 'Nons'),
(11, 'angol buldog', 'kan', 0, 'Bogár'),
(12, 'angol buldog', 'szuka', 0, 'Csipisz'),
(13, 'angol szetter', 'szuka', 0, 'Marcipán'),
(14, 'angol szetter', 'kan', 0, 'Picasso'),
(15, 'angol véreb', '', 0, 'Dolly'),
(16, 'argentin dog', '', 0, 'Cindy'),
(17, 'argentin dog', 'kan', 0, 'Plútó'),
(18, 'argentin dog', 'kan', 0, 'Vili'),
(19, 'argentín dog staffordshire terrier keverék', 'kan', 0, 'Geri'),
(20, 'argentín dog staffordshire terrier keverék', 'kan', 0, 'Pamacs'),
(21, 'basset hound', 'kan', 0, 'Néró'),
(22, 'basset hound', 'szuka', 1, 'Bella'),
(23, 'basset hound', 'szuka', 0, 'Nelli'),
(24, 'beagle', 'kan', 0, 'Brúnó'),
(25, 'beagle', 'szuka', 3, 'Sziszi'),
(26, 'beagle', 'szuka', 1, 'Tódi'),
(27, 'beagle', 'kan', 0, 'Hops'),
(28, 'beagle', 'kan', 0, 'Vándor'),
(29, 'beagle', '', 0, 'Maci'),
(30, 'beagle', 'szuka', 0, 'Lilla'),
(31, 'beagle', 'kan', 8, 'Brutus'),
(32, 'beagle', 'szuka', 0, 'Pötyi'),
(33, 'beagle', '', 0, 'Zsebi'),
(34, 'beagle', '', 0, 'Cipi'),
(35, 'beagle', 'kan', 0, 'Herceg'),
(36, 'beagle', 'kan', 0, 'Marci'),
(37, 'beagle', 'szuka', 0, 'Fáni'),
(38, 'beagle', 'szuka', 0, 'Dorka'),
(39, 'beagle', 'szuka', 0, 'Topi'),
(40, 'bearded collie', '', 11, 'Bodza'),
(41, 'bearded collie', 'kan', 8, 'Boglya'),
(42, 'belga juhász', 'kan', 0, 'Bogyó'),
(43, 'belga juhász', 'szuka', 1, 'Bubu'),
(44, 'belga juhász', 'kan', 0, 'Pözsó'),
(45, 'belga juhász keverék', 'kan', 0, 'Fickó'),
(46, 'belga juhász keverék', 'szuka', 10, 'Piri'),
(47, 'belga juhász keverék', 'kan', 3, 'Rocky'),
(48, 'bernáthegyi', '', 0, 'Rocky'),
(49, 'bernáthegyi', 'kan', 5, 'Aladár'),
(50, 'bernáthegyi keverék', '', 0, 'Viktória'),
(51, 'berni pásztor', 'szuka', 5, 'Dini'),
(52, 'berni pásztor', 'szuka', 0, 'Fáni'),
(53, 'berni pásztor', 'kan', 1, 'Rocky'),
(54, 'berni pásztor', 'szuka', 0, 'Dorka'),
(55, 'berni pásztor', 'kan', 2, 'Dani'),
(56, 'berni pásztor', 'kan', 8, 'Bokszos'),
(57, 'berni pásztor', 'szuka', 3, 'Bogyó'),
(58, 'berni pásztor', 'szuka', 0, 'Nelli'),
(59, 'berni pásztor', 'kan', 5, 'Johny'),
(60, 'berni pásztor', 'szuka', 2, 'Ági'),
(61, 'berni pásztor skótjuhász keverék', 'szuka', 0, 'Fáni'),
...
(70, 'boxer keverék', 'kan', 0, 'Maszat'),
(71, 'bullterrier', 'szuka', 0, 'Süti'),
(72, 'briard', 'kan', 0, 'Soma'),
(73, 'cavalier spániel', 'szuka', 0, 'Bogyó'),
(74, 'cocker spániel', '', 0, 'Buffy'),
(75, 'cocker spániel', 'kan', 2, 'Cottó'),
(76, 'cocker spániel', 'szuka', 0, 'Izidor'),
(77, 'cocker spániel', 'szuka', 14, 'Fáncsi'),
(78, 'cocker spániel', 'szuka', 0, 'Fanni'),
...
(86, 'cocker spániel-uszkár keverék', '', 0, 'Bogáncs'),
(87, 'collie', 'szuka', 5, 'Süti'),
(88, 'collie', 'szuka', 4, 'Csutak'),
(89, 'collie', 'szuka', 1, 'Gina'),
(90, 'collie', 'szuka', 2, 'Léna'),
(91, 'collie', 'szuka', 0, 'Lilla'),
(92, 'collie keverék', 'kan', 1, 'Dodó'),
(93, 'Csau-csau', '', 0, 'Brúnó'),
(94, 'csau-csau keverék', 'szuka', 4, 'Szõrmók'),
(95, 'csivava-tacskó keverék', 'szuka', 8, 'Léna'),
(96, 'csivava yorkshire terrier keverék', '', 1, 'Dönci'),
(97, 'csivava', 'szuka', 0, 'Kati'),
(98, 'dalmata', 'szuka', 8, 'Bagó'),
(99, 'dalmata', 'kan', 6, 'Csoma'),
(100, 'doberman', 'szuka', 5, 'Szandra'),
(101, 'doberman', 'kan', 2, 'Jimmy'),
(102, 'erdélyi kopó tacskó keverék', 'kan', 4, 'Krõte'),
(103, 'erdélyi kopó', 'szuka', 3, 'Kajak'),
(104, 'erdélyi kopó', 'kan', 5, 'Ugri'),
(105, 'fila', 'kan', 7, 'Tockos'),
(106, 'foxterrier', 'szuka', 0, 'Bogár'),
(107, 'foxterrier', 'szuka', 0, 'Hádész'),
(108, 'foxterrier', 'kan', 6, 'Roxi'),
(109, 'foxterrier', 'szuka', 0, 'Mókus'),
(110, 'foxterrier keverék', '', 0, 'Fillér'),
(111, 'foxterrier és palotakutya keverék', 'kan', 0, 'Kanóc'),
(112, 'foxterrier keverék', 'szuka', 2, 'Bogi'),
(113, 'francia buldog', 'kan', 1, 'Buck'),
(114, 'francia buldog', '', 1, 'Berci'),
(115, 'golden retriever', 'kan', 0, 'Picúr'),
(116, 'golden retriever', 'kan', 0, 'Topi'),
(117, 'golden retriever', 'szuka', 0, 'Zsömi'),
(118, 'golden retriever', 'szuka', 8, 'Leila'),
(119, 'golden retriever', 'szuka', 5, 'Mackó'),
(120, 'golden retriever', 'kan', 5, 'Artúr'),
(121, 'golden retriever', 'kan', 0, 'Bobi'),
(122, 'golden retriever', 'szuka', 4, 'Zsömi'),
(123, 'golden retriever', 'szuka', 4, 'Csuvi'),
(124, 'golden retriever', 'kan', 1, 'Picúr'),
(125, 'golden retriever', 'szuka', 0, 'Csuvi'),
(126, 'golden retriever', 'szuka', 5, 'Betyár'),
(127, 'golden retriever', '', 0, 'Alex'),
(128, 'golden retriever', '', 0, 'Pici'),
(129, 'golden retriever', 'kan', 0, 'Csipke'),
(130, 'golden retriever', 'szuka', 1, 'Buksi'),
(131, 'golden retriever', 'szuka', 3, 'Csibi'),
(132, 'golden vizsla keverék', 'kan', 0, 'Morgó');